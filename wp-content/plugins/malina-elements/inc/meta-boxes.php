...
function malina_register_meta_boxes($meta_boxes) {
	...
	if(class_exists('RevSlider')){
		...
		$rev_option2 = array(
    	   'name' => esc_html__('Show posts carousel?', 'malina-elements'),
    	   'desc' => sprintf('<a href="#malina_page_herosection_hellotext">%s</a>', esc_html__('Options for carousel here','malina-elements')),
    	   'id' => $prefix . 'page_herosection_revslider_posts',
    	   'type' => 'select',
		   'options' => array('hide' => esc_html__('Hide', 'malina-elements'), 'show' => esc_html__('Show', 'malina-elements') ),
		   'std'  => array('hide'),
    	);
	    $rev_option = array(
