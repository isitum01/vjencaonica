		...
		return [
			...
			el( InspectorControls, {},
				...
				el( TextControl, {
					...
					help : '<a href="https://api.instagram.com/oauth/authorize?client_id=423965861585747&redirect_uri=https://connect.smashballoon.com/auth/ig/instagram-basic-display-redirect.php&response_type=code&scope=user_profile,user_media&state={%27{url=https://malina.artstudioworks.net/auth/admin.php?page=sb-instagram-feed,opt=out}%27}" target="_blank">'+__('Generate access token', 'malina-elements')+'</a>',
