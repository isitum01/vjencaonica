...
class malina_widget_instagram_new extends WP_Widget { 
	...
	function form($instance) {
		...
		<p>
			...
			<input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id( 'access_token' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'access_token' )); ?>" value="<?php echo esc_attr($instance['access_token']); ?>" /><br /><a target="_blank" href="https://api.instagram.com/oauth/authorize?client_id=423965861585747&redirect_uri=https://connect.smashballoon.com/auth/ig/instagram-basic-display-redirect.php&response_type=code&scope=user_profile,user_media&state={%27{url=https://malina.artstudioworks.net/auth/admin.php?page=sb-instagram-feed,opt=out}%27}"><?php _e('Get your Access Token','malina-elements'); ?></a>
		</p>
		<p>
