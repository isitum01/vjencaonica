...
class Widget_ASW_recent_posts extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_posts_box',
			[
				'label' => __( 'Box', 'malina-elements' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'post_style' => ['style_10', 'style_1']
				]
			]
		);
		...
		$this->add_responsive_control(
			'box_paddings',
			[
				'label' => __( 'Box padding', 'malina-elements' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'default' => ['top'=>'5', 'right'=>'5', 'bottom'=>'5', 'left'=>'5', 'unit'=>'px'],
				'selectors' => [
					'{{WRAPPER}} #latest-posts .blog-posts .post.post-size .post-content-container .post-img-block' => 'border:0',
					'{{WRAPPER}} #latest-posts .blog-posts .post.post-size .post-content-container .post-content-block' => 'padding:0',
					'{{WRAPPER}} #latest-posts .blog-posts .post.post-size .post-content-container' => 'padding: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}}',
				]
			]
		);
		$this->add_responsive_control(
			'border_radius',
			[
				'label' => __( 'Box border radius', 'malina-elements' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'default' => ['top'=>'5', 'right'=>'5', 'bottom'=>'5', 'left'=>'5', 'unit'=>'px'],
				'selectors' => [
					'{{WRAPPER}} #latest-posts .blog-posts .post.post-size .post-img-block .post-img img' => 'border-radius: {{top}}{{unit}} {{right}}{{unit}} 0 0',
					'{{WRAPPER}} #latest-posts .blog-posts .post.post-size div[class*=preview-post-gallery] img' => 'border-radius: {{top}}{{unit}} {{right}}{{unit}} 0 0',
					'{{WRAPPER}} #latest-posts .blog-posts .post.post-size .post-content-container' => 'border-radius: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}}',
				]
			]
		);
		$this->add_control(
			...
			[
				'label' => __( 'Box background color', 'malina-elements' ),
				...
				'default'=>'#ffffff',
				'selectors' => [
					'{{WRAPPER}} #latest-posts .blog-posts .post.post-size .post-content-container' => 'background-color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				'name' => 'box_shadow',
				'label' => __( 'Box Shadow', 'malina-elements' ),
				'selector' => '{{WRAPPER}} #latest-posts .blog-posts .post.post-size .post-content-container',
			]
		);
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} #latest-posts .blog-posts .post.post-size .post-img-block' => 'margin-bottom: {{SIZE}}{{UNIT}} !important'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'condition' => [
					'post_style' => ['style_1', 'style_10', 'style_11']
				],
				'selectors' => [
					...
					'{{WRAPPER}} #latest-posts .blog-posts .post.style_10:not(.sticky):not(.post-featured) .post-img a' => 'padding-bottom: calc( {{SIZE}} * 100% )',
				]
			]
		);
		...
		$this->add_control(
			'title_color',
			[
				'label' => __( 'Title Color', 'malina-elements' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => [
					'type' => Core\Schemes\Color::get_type(),
					'value' => Core\Schemes\Color::COLOR_1,
		...
		$this->add_control(
			'content_color',
			[
				'label' => __( 'Content Color', 'malina-elements' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => [
					'type' => Core\Schemes\Color::get_type(),
					'value' => Core\Schemes\Color::COLOR_1,
		...
		$this->add_responsive_control(
			'content_paddings',
			[
				'label' => __( 'Content padding', 'malina-elements' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'default' => ['top'=>'40', 'right'=>'30', 'bottom'=>'30', 'left'=>'30', 'unit'=>'px'],
				'selectors' => [
					'{{WRAPPER}} #latest-posts .blog-posts .post.post-size .post-content-container .post-content-block' => 'padding: {{top}}{{unit}} {{right}}{{unit}} {{bottom}}{{unit}} {{left}}{{unit}}',
				],
				'condition' => [
					'post_style' => ['style_10']
				]
