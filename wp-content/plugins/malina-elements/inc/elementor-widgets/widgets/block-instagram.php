	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => '<a target="_blank" href="https://api.instagram.com/oauth/authorize?client_id=423965861585747&redirect_uri=https://connect.smashballoon.com/auth/ig/instagram-basic-display-redirect.php&response_type=code&scope=user_profile,user_media&state={%27{url=https://malina.artstudioworks.net/auth/admin.php?page=sb-instagram-feed,opt=out}%27}">'.esc_html__('Get your Access Token','malina-elements').'</a>',
				'type' => Controls_Manager::TEXT,
