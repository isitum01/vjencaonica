<div id="header-main" class="<?php if( get_theme_mod('malina_fixed_header', true) ) echo 'fixed_header'; ?>">
	<header id="header" class="header4 clearfix">
		...
		<?php } ?>
		<div class="<?php echo get_theme_mod('malina_header_grid','container header-fullwidth'); ?>">
				<div class="span12">
					<div class="logo">
					...
					<?php } ?>
						...
						<?php } else { ?>
							<a href="<?php echo esc_url(home_url('/')); ?>" class="logo_text"><?php echo esc_html( get_bloginfo( 'name' ) ); ?>
							<?php if( get_theme_mod('malina_logo_tagline_show', false) ){ echo '<p class="tagline">'.esc_html(get_bloginfo('description')).'</p>'; }?></a>
						<?php } ?>
					</div>
