...
$excerpt_count = get_theme_mod('malina_blog_excerpt_count', '15');
...
} elseif( get_theme_mod('malina_home_hero_slider', 'none' ) == 'revslider' ) {
	get_template_part('templates/blog/revslider');
	...
	<div id="content" class="<?php echo esc_attr($sidebar_pos); ?>">
		<div class="row">
			...
			$display_date = ($display_date == 'true' || $display_date=='1' || $display_date=='hover');
	      	...
	      	$show_readmore = get_theme_mod( 'malina_display_read_more', false);
			...
			if( $pagination == 'true' && get_next_posts_link() ) {
				...
				$out .= '<div id="pagination" class="pagination hide">'.get_next_posts_link().'</div>';
