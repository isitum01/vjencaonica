...
/**
 * Class Vjencaonica_View_Models_Loader
...
class Vjencaonica_View_Models_Loader {
	...
	public function load_theme_view_models() {
		...
		$view_models_dir_name = apply_filters( 'vjencaonica_view_models_dir', 'view-models' );

		// Get view models dir
		$view_models_dir = get_template_directory() . '/' . $view_models_dir_name;
