...
/**
 * Class Vjencaonica_Twig_Extension_Svg
 * @package VjencaonicaStarter
 */
class Vjencaonica_Twig_Extension_Svg extends Twig_Extension {
	...
	public function load_svg( $svg_relative_path ) {
		...
		// Get svg file path
		$default_svg_path = get_template_directory() . '/assets/images/';
		$svg_path         = apply_filters( 'vjencaonica_svg_path', $default_svg_path );
