...
#header .menu-item.update-label > a:after, #mobile-header-block .menu-item.update-label > a:after {
    color:<?php echo esc_attr(get_theme_mod('malina_accent_color', '#d87b4d')); ?> !important;
}
#header .menu-item.update-label > a:after, #mobile-header-block .menu-item.update-label > a:after {
    background-color:rgba(<?php echo HexToRGB(get_theme_mod('malina_accent_color', '#d87b4d')); ?>, 0.1);
}
